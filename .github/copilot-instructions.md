...
Branch name: `{type}/{description}` (e.g., `feat/add-tool`, `fix/error-handling`)

## Development Workflow

1. Create branch (`{type}/{description}`)
2. Create `.pdd/{branch}/PLAN.md`
3. Review and refine PLAN.md before implementation
4. Implement
